...
def input_parser(numerical_type=NUMERICAL_TYPE):
    ...
    parser.add_argument('-dw0', dest='wafer_thickness_g0',
                        action=_TruePositiveNumber,
                        type=numerical_type,
    ...
    parser.add_argument('-df0', dest='fill_thickness_g0',
                        action=_TruePositiveNumber,
                        type=numerical_type,
    ...
    parser.add_argument('-dw1', dest='wafer_thickness_g1',
                        action=_TruePositiveNumber,
                        type=numerical_type,
    ...
    parser.add_argument('-df1', dest='fill_thickness_g1',
                        action=_TruePositiveNumber,
                        type=numerical_type,
    ...
    parser.add_argument('-dw2', dest='wafer_thickness_g2',
                        action=_TruePositiveNumber,
                        type=numerical_type,
    ...
    parser.add_argument('-df2', dest='fill_thickness_g2',
                        action=_TruePositiveNumber,
                        type=numerical_type,
